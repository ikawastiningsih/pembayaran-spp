...
?>
<br>
<form class="form-horizontal" action="../config/editakunguruproses.php" method="POST">
	<ol class="breadcrumb">
      <li class="active"><b>EDIT AKUN GURU</b></li>
       </ol>
	...
	<div class="form-group">
		...
		<label class="col-sm-1">:</label>
		<label class="col-sm-4"><input class="form-control" name="nama_pegawai" type="text" value="<?php echo $data['jk_pegawai']; ?>" required></label>
	</div>
