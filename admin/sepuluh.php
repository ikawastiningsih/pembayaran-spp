    ...
    <li class="page-item">
      <a class="page-link" href="#" aria-label="Previous">
        ...
        <span class="sr-only">Next</span>
            ...
            <a href="cetaksepuluh.php" target="_BLANK" role="button" class="btn btn-primary pull-right" style="margin-right:16px;margin-bottom:10px;width:150px"><span class="fa fa-print"></span> Cetak Report</a>
