...
<body onload="window.print()">
    ...
    <div class="panel panel-default"">
        ...
        <?php
            ...
            error_reporting(0);
            $query1 = "SELECT * FROM datasiswa where kelas='Lulus'";
            $tampil1 = mysqli_query($konek, $query1)or die(mysqli_error($konek));
            $no =1;
           
        ?>
<body>
<h4><center>DATA SISWA ALUMNI SMK JAYAKARTA</h4>
    <br>
<table class="table1">
  <tr>
    <th class="bg-info"><center><font size="2px">No</th>
    <th class="bg-info"><center><font size="2px">NIS</th>
    <th class="bg-info"><center><font size="2px">NISN</th>
    <th class="bg-info"><center><font size="2px">Tahun Ajaran Masuk</th>   
    ...
    <th class="bg-info"><center><font size="2px">No. Handphone</th>
    <th class="bg-info"><center><font size="2px">Alamat</th>
    <th class="bg-info"><center><font size="2px">Agama</th>
    <th class="bg-info"><center><font size="2px">Nama Ayah</th>
    <th class="bg-info"><center><font size="2px">Nama Ibu</th>
    <th class="bg-info"><center><font size="2px">No. UN</th>
    <th class="bg-info"><center><font size="2px">No. Ijazah</th>
  </tr>
  <?php
