...
<body onload="window.print()">
    ...
    <div class="panel panel-default"">
        ...
        <?php
            ...
            error_reporting(0);
            $query1 = "SELECT id_siswa, nis, nama_siswa, kelas, sum(pemasukan), sum(pengeluaran), sum(pemasukan) - sum(pengeluaran) as jumlah FROM tabungan group by id_siswa";
            $tampil1 = mysqli_query($konek, $query1)or die(mysqli_error($konek));
            $no =1;
           
        ?>
<body>
<h4><center>DATA TABUNGAN SISWA</h4>
    <br>
<table class="table1" >
  <tr>
    <th class="bg-info"><center><font size="2px">No</th>
    <th class="bg-info"><center><font size="2px">NIS</th> 
    <th class="bg-info"><center><font size="2px">Nama Siswa</th>
    <th class="bg-info"><center><font size="2px">Kelas</th>
    <th class="bg-info"><center><font size="2px">Pemasukan</th>
    <th class="bg-info"><center><font size="2px">Pengeluaran</th>
    <th class="bg-info"><center><font size="2px">Jumlah Tabungan</th>
  </tr>
  <?php
  while($row = mysqli_fetch_array($tampil1)) { ?>
    <tr>
        ...
        <td><center><font size="2px"><?php echo $row['sum(pemasukan)']; ?></td>  
        <td><center><font size="2px"><?php echo $row['sum(pengeluaran)']; ?></td>
        <td><center><font size="2px"><?php echo $row['jumlah']; ?></td>
    </tr>
<?php }
?>
</table>
